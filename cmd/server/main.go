...
import (
	...
	"portfolio-management/internal/marketsource/coingecko"
	"portfolio-management/internal/marketsource/eastmoney"
...
func main() {
	...
	priceScheduler.SetEventBus(eventBus)
	...
	api.GET("/events", sseHandler.Handle)
